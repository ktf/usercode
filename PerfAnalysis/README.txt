...
Notice that according to Lassi the four process in parallel did not made
pretty much any difference which probably means that we are still in the 
"chinese motorway" mode (lot's of bicycles on a motorway), in the sense that 
we suck so much performance wise that concurrent processing is a second order 
problem.
